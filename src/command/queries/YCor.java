...
public class YCor extends CursorCommand {
    public static final int MY_NUMBER_OF_COMMAND_PARAMETERS = 0;
    
    public YCor (Map<String, Variable> variableMap, List<AbstractCommand> inputs, Cursor cursor) {
    ...
    public double execute() {
        return getCursor().getCoordinate().getY();
    }
