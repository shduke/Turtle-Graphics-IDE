...
public class ColorBehavior extends BinaryBehavior<Double, String, Double> {
    ...
    public ColorBehavior (BiFunction<Double, String, Double> operation,
    ...
    protected <R> String getInput2 () {
        return toColorString(getExecutionResult(R_INDEX), getExecutionResult(G_INDEX),
                             getExecutionResult(B_INDEX));
    }
